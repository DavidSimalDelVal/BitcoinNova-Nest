...
// Package bitcoinnovawalletdrpcgo handles the the rpc connection between your app and Bitcoinnova-service
package bitcoinnovawalletdrpcgo
...
// returned balances are expressed in BTN, not in 0.01 BTN
...
// RequestStatus requests Bitcoinnova-service connection and sync status
...
// threshold is the value that determines which outputs will be optimized. Only the outputs, lesser than the threshold value, will be included into a fusion transaction (threshold is expressed in BTN, not 0.01 BTN).
