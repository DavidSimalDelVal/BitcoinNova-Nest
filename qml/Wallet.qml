...
Rectangle {
    ...
    Rectangle {
        ...
        Text {
            ...
            color: "#858585"
            text: "Copy your address to receive BTN"
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            TextInput {
                ...
                onTextChanged: {
                    ...
                    textInputTransferPaymentID.enabled = textInputTransferAddress.text.length != 183
                }
            }
        }
        ...
        Button {
            ...
            onClicked: {
                ...
                dialogConfirmTransfer.show(rectangleTransfer.transferRecipient, rectangleTransfer.transferAmount + " BTN + " + rectangleTransfer.transferFee + " (fee) + " + rectangleTransfer.nodeFeeValue + " (node fee)", rectangleTransfer.transferPaymentID);
            }
        }
